                            ...
                            <table cellpadding="0" cellspacing="0" style="width:100%">
                                <tbody>
                                    <tr>
                                        <td style="width:60%">
                                            <div>
                                                <a><span style="font-size:14px">{{ $product_name }}</span></a>
                                            </div>
                                            <div>
                                                <span
                                                    style="font-size:14px">{{ number_format($qty * $price, 0, '', '.') }}đ</span>
                                            </div>
                                            <div>
                                                <span style="font-size:14px">Số lượng: {{ $qty }}</span>
                                            </div>
                                        </td>
                                    </tr>
                                </tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td align="right" valign="top">
                                                <div style="color:#f27c24;font-weight:bold">
                                                    ...
                                                    {{ number_format($qty * $price + 30000, 0, '', '.') }}
                                                </div>
                                            </td>
                                        </tr>
                                    </tbody>
