    ...
    <div class="row">
        <div class="col-4">
            <div class="card">
                ...
                @endif
                <div class="card-body">
                    <form action="{{route('post.cat.update', $post_cat->id)}}" method="POST">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="" name="parent_id">
                                ...
                                @foreach ($cats as $cat)
                                    <option value="{{$cat->id}}" @if($post_cat->parent_id == $cat->id)
                                        selected='selected'
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="status" id="status1" value="Chờ duyệt" @if($post_cat->status =='Chờ duyệt') checked @endif>
                                <label class="form-check-label" for="status1">
                                Chờ duyệt
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="status" id="status2" value="Công khai" @if($post_cat->status== 'Công khai') checked @endif>
