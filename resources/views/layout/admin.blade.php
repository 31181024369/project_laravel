...
<head>
    ...
    <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css" integrity="sha384-ggOyR0iXCbMQv3Xipma34MD+dH/1fQ784/j6cY/iJTQUOhcWr7x9JvoRxT2MZw1T" crossorigin="anonymous">
     ...
     <script src="https://cdn.tiny.cloud/1/m8mdtlyhr9abd4fnlxanxxxakd4pjpeh9nzs3rbekit7pgmj/tinymce/5/tinymce.min.js" referrerpolicy="origin"></script>

      <script>
        var editor_config = {
        path_absolute : "http://localhost/unitop.vn/unimart_pro/unimart/",
        selector: 'textarea',
        relative_urls: false,
        plugins: [
        ...
        <div id="page-body" class="d-flex">
            <div id="sidebar" class="bg-white">
                <ul id="sidebar-menu">
                    ...
                    <li class="nav-link active {{$module_active=='product'?'active':''}}">
